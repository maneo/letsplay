...
# ai_model = pickle.load(open("forest_synth_126.pkl", "rb"))
# ai_model = pickle.load(open("mlp_synth_126.pkl", "rb"))
ai_model = pickle.load(open("xgb_synth_126.pkl", "rb"))
