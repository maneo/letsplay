...
def dump_as_vector(mobs, player, bullets, pygame, wasShooting, frame_cnt):
    state = []
    keystate = pygame.key.get_pressed()
    ...
    # do not limit number of frames because modulo is applied in play mode
...
while running:
    ...
    dump_as_vector(mobs, player, bullets, pygame, wasShooting, frame_cnt)
